...
public class MyRectangle extends MyBoundedShape
{
    ...
    /**
     * Class constructor that initialized all the coordinates and color of a rectangle.
    ...
    /**
     * {@inheritDoc}
     * This method overrides the draw method from the MyShape superclass for a rectangle.
    ...
    public void draw(Graphics g)
    {
        ...
        if (getFilled())
            g.fillRect(coorX(), coorY(), width(), height());
        else
            g.drawRect(coorX(), coorY(), width(), height());
    }
}
